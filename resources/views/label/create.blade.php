    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4 ">
                ...
                <form action="{{ route('labels.store') }}" method="post" enctype="multipart/form-data" id="image-upload">
                    @csrf
                    ...
                    <div>
                        <h2 class="text-lg text-blue-700">2. Enter the label information</h2>
                    </div>
                    <div class="py-4 flex flex-wrap">
                        <div class="flex flex-col w-1/2 lg:w-1/4 py-2 px-2">
                            ...
                            <input type="text" id="shape_stone" name="shape_stone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                        </div>
                        <div class="flex flex-col w-1/2 lg:w-1/4 py-2 px-2">
                            <label for="weight" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Weight</label>
                            <input type="text" id="weight" name="weight" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                        </div>
                        <div class="flex flex-col w-1/2 lg:w-1/4 py-2 px-2">
