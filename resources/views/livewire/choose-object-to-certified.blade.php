<div>
    ...
    <div class="flex flex-wrap py-3">
        <div class="flex flex-col w-1/2 lg:w-1/3 px-2">
            <div class="w-1/2 flex flex-row items-center">
                <input type="text" id="jewel_weight_title" name="jewel_weight_title" class="bg-white w-24 border-0 border-b border-gray-900 mb-2 text-sm font-medium text-gray-900 dark:text-white block p-2.5 focus:ring-0">
        ...
        <div class="flex flex-col w-1/2 lg:w-1/3 px-2">
            <div class="w-1/2 flex flex-row items-center">
                <input type="text" id="diamond_weight_title" name="diamond_weight_title" class="bg-white w-24 border-0 border-b border-gray-900 mb-2 text-sm font-medium text-gray-900 dark:text-white block p-2.5 focus:ring-0">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Weight</label>
            </div>
        ...
        <div class="flex flex-col w-1/2 lg:w-1/3 px-2">
            <div class="w-1/2 flex flex-row items-center">
                <input type="text" id="gemstone_weight_title" name="gemstone_weight_title" class="bg-white w-24 border-0 border-b border-gray-900 mb-2 text-sm font-medium text-gray-900 dark:text-white block p-2.5 focus:ring-0">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Weight</label>
            </div>
    ...
    <div class="py-4">
        <div class="w-1/2 flex flex-row items-center">
            ...
            <input type="text" id="center" name="center" class="bg-white border-0 border-b border-blue-700 text-blue-700 text-md block p-2.5 focus:ring-0">
        </div>
        <div class="flex flex-wrap py-3">
    ...
    <div class="py-4">
        <div class="w-1/2 flex flex-row items-center">
            ...
            <input type="text" id="other_1" name="other_1" class="bg-white border-0 border-b border-blue-700 text-blue-700 text-md block p-2.5 focus:ring-0">
        </div>
        <div class="flex flex-wrap py-3">
            <div class="flex flex-col w-1/2 lg:w-1/4 py-2 px-2">
    ...
    <div class="py-4">
        <div class="w-1/2 flex flex-row items-center">
            <h2 class="text-md text-center text-blue-700 pr-2">Other</h2>
            <input type="text" id="other_2" name="other_2" class="bg-white border-0 border-b border-blue-700 text-blue-700 text-md block p-2.5 focus:ring-0">
        </div>
        <div class="flex flex-wrap py-3">
            <div class="flex flex-col w-1/2 lg:w-1/4 py-2 px-2">
    ...
    <div class="py-4">
        <div class="w-1/2 flex flex-row items-center">
            <h2 class="text-md text-center text-blue-700 pr-2">Other</h2>
            <input type="text" id="other_3" name="other_3" class="bg-white border-0 border-b border-blue-700 text-blue-700 text-md block p-2.5 focus:ring-0">
        </div>
        <div class="flex flex-wrap py-3">
            <div class="flex flex-col w-1/2 lg:w-1/4 py-2 px-2">
    ...
    <div class="py4">
        <div class="flex flex-row w-full px-2 py-3 items-center">
            ...
            <input type="text" id="est_price" name="est_price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
        </div>
    </div>
    {{-- Fin 3) Other diamond --}}
</div>
